    ...
    <div className="container mt-5">
      ...
      <div className="jumbotron bg-dark text-white">
        <ul className="list-unstyled">
          <li className="media">
            <img src="./assets/images/smite.jpg" className="mr-3" alt="..." />
          ...
          <li className="media my-4">
            <img src="./assets/images/crystal.jpg" className="mr-3" alt="..." />
            <div className="media-body">
          ...
          <li className="media my-4">
            <img src="./assets/images/strangerthings.jpg" className="mr-3" alt="..." />
            <div className="media-body">
          ...
          <li className="media my-4">
            <img src="./assets/images/giphyapi.gif" className="mr-3" alt="..." />
            <div className="media-body">
          ...
          <li className="media my-4">
            <img src="./assets/images/train.png" className="mr-3" alt="..." />
            <div className="media-body">
          ...
          <li className="media my-4">
            <img src="./assets/images/liri.jpg" className="mr-3" alt="..." />
            <div className="media-body">
          ...
          <li className="media my-4">
            <img src="./assets/images/angelhare.jpg" className="mr-3" alt="..." />
            <div className="media-body">
          ...
          <li className="media my-4">
            <img src="./assets/images/bamazon.png" className="mr-3" alt="..." />
            <div className="media-body">
          ...
          <li className="media my-4">
            <img src="./assets/images/googlebooks.png" className="mr-3" alt="..." />
            <div className="media-body">
          ...
          <li className="media my-4">
            <img src="https://c1.staticflickr.com/9/8143/7564361612_058949c8c8_m.jpg" className="mr-3" alt="..." />
            <div className="media-body">
