    ...
    <div className="container mt-5">
      ...
      <div className="jumbotron bg-dark text-white">
        <div className="clearfix mb-4">
          <img src="./assets/images/smite.jpg" className="float-left rounded mr-3" alt="..." />
        ...
        <div className="clearfix mb-4">
          <img src="./assets/images/crystal.jpg" className="float-left rounded mr-3" alt="..." />
        ...
        <div className="clearfix mb-4">
          <img src="./assets/images/strangerthings.jpg" className="float-left rounded mr-3" alt="..." />
        ...
        <div className="clearfix mb-4">
          <img src="./assets/images/giphyapi.gif" className="float-left rounded mr-3" alt="..." />
        ...
        <div className="clearfix mb-4">
          <img src="./assets/images/train.png" className="float-left rounded mr-3" alt="..." />
        ...
        <div className="clearfix mb-4">
          <img src="./assets/images/liri.jpg" className="float-left rounded mr-3" alt="..." />
        ...
        <div className="clearfix mb-4">
          <img src="./assets/images/googlebooks.png" className="float-left rounded mr-3" alt="..." />
        ...
        <div className="clearfix mb-4">
          <img src="https://c1.staticflickr.com/9/8143/7564361612_058949c8c8_m.jpg" className="float-left rounded mr-3" alt="..." />
